...
public class TenantRegisterService {
    ...
    public TenantDatabaseDTO initDatabase(TenantRegisterBody form) throws Exception {
        ...
        try {
            ...
            //mysql 5.0 用户授权和创建String grantSQL = "GRANT select, insert, update, delete ON " + tenantDatabase + ".* TO '" + tenantDatabaseUsername + "'@'localhost' IDENTIFIED BY '" + tenantDatabasePassword + "'";
